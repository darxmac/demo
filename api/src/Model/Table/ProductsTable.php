 ...
 * Products Model
 *
 * @property \App\Model\Table\ProductFieldsTable&\Cake\ORM\Association\BelongsToMany $ProductFields
 *
...
class ProductsTable extends Table
{
    ...
    public function initialize(array $config): void
    {
        ...
        $this->belongsToMany('ProductFields', [
            'foreignKey' => 'product_id',
            'targetForeignKey' => 'product_field_id',
            'joinTable' => 'products_product_fields',
            'through' => 'ProductsProductFields',
        ]);
    }
