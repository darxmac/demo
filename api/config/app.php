...
return [
    ...
    'App'            => [
        ...
        'languages'      => [
            ['locale' => 'da_DK', 'name' => 'Dansk', 'isPrimary' => true],
            ['locale' => 'sv_SE', 'name' => 'Svensk', 'isPrimary' => false],
            ['locale' => 'nb_NO', 'name' => 'Norsk', 'isPrimary' => false]
        ],
    ...
    'Cache'          => [
        ...
        'resized_images'       => [
            'className' => FileEngine::class,
            'path'      => CACHE .DS.'resized_images',
            'url'       => env('CACHE_DEFAULT_URL', null),
        ],
        'ephemeral' => [
            'className' => \Cake\Cache\Engine\ArrayEngine::class,
        ],
        /*
     ...
     */
    'Password' => [
        'Cost' => 10 // @todo Must be 10 to not confuse cake, NO IDEA how to set cost in their password identity
    ]
];
